...
- **D1 직함 문맥 탐지**(2026-09-21 추가, **코드만 — 아직 아무 경로도 부르지 않는다**): 명세는 리포 밖
  `design/c1b2/d1_detection_policy_v1.md`(sha256 `47d090a6…`). `tools/fixture_capture/d1_observe.py`(§3~§5)가 블록 소유
