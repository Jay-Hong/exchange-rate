...
ADR-034 §6/§7/§9 Amendment. PR A1 cron 검증 중 발견된 provenance 불일치 정정. **Stage 1+2+3 land 완료** (2026-06-01 — production RDS 11 rows surgical rename old 0→new 11 / drift 0 / 다음 cron 적재 검증 pending).
