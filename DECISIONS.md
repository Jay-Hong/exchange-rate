...
**Open (후속)**: KRX stub(`KRX_2026_KNOWN_HOLIDAYS`)을 공유 calendar base로 migration / crawler-success heartbeat (평일 liveness 정확화) / 임시공휴일 override (라이브러리 lag 시). [Hana production cron 포함 = **PR A2 완료** — cron `--source all` 교체 deploy 2026-06-01 + 2026-06-02 00:01 KST 통합 관찰 41→43]
