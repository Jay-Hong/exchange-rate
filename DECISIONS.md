...
**Status**: Proposed (2026-06-05) — Phase 2e v2 endpoint 진입 전 결정. ADR-033 Decision 10 + ADR-034 후속. **D1 Investing land 2026-06-05** (writer `4f38b05`+`a11e6f7` + production 837 rows, source_daily_rates 1357→2194; D2-D4 미진입). (DECISIONS "장기 그래프 DB 표준화 (Phase 2e 진입 전 결정)" 노트 + [GRAPH_API_V2_CONTRACT.md](GRAPH_API_V2_CONTRACT.md) §catalog 1w open question을 본 ADR로 확정.)
