...
(`app/scheduler.py:1402-1412` · `app/main.py:904-927`).
...
caller 도 변경이 있을 때만 publish 한다(`app/main.py:904-927`). transport ping/pong 은 **연결
...
· **B1**(publisher 모듈 내부 timer 부재) · `app/main.py:904-927`(외부 caller 도 변경 시에만 publish).
