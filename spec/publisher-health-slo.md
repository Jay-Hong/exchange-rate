...
(`app/scheduler.py:1907-1913` · `app/main.py:980-1003`).
...
외부 caller도 변경이 있을 때만 publish한다(`app/main.py:980-1003`). transport ping/pong은 **연결
...
· **B1**(publisher 모듈 내부 timer 부재) · `app/main.py:980-1003`(외부 caller 도 변경 시에만 publish).
