...
- **parity(S5)**: would_fire(attempted, pre-send `_shadow_noop_sender`:53) ≥ sent_count(delivered, success>0 crud:2233) 경향 — dedicated cache staleness + async refetch under-count로 exact 아님. tolerance 정의는 S5(plan open §5).
