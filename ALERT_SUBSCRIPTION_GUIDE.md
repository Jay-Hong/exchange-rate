...
1. [결정된 아키텍처](#-결정된-아키텍처)
2. [개인화 알림 동작 흐름](#-개인화-알림-동작-흐름)
3. [환율 알림 서비스 구현 방법](#1-환율-알림-서비스-구현-방법)
4. [크로스 플랫폼 구독 관리 방법](#2-크로스-플랫폼-구독-관리-방법)
5. [비용 비교 시나리오](#3-비용-비교-시나리오)
6. [구현 난이도 및 기간](#4-구현-난이도-및-기간)
7. [다음 단계](#5-다음-단계)
