...
class TestDormancy(unittest.TestCase):
    ...
    _ISLAND = frozenset({
        ...
        "atomic_coordinator.py", "atomic_retry.py", "atomic_cutover_durable.py", "atomic_cutover_runtime.py", "atomic_fx_v2_loader.py", "atomic_fx_publisher.py", "atomic_watermark_store.py", "atomic_fx_live.py", "atomic_write_durable.py", "atomic_quiesce_durable.py",
    })
